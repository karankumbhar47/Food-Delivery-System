...
public class DefaultApi {
  ...
  String basePath = "http://192.168.37.69:8080";
  ...
  * Confirm Order Delivery
   ...
   * @return Integer
  */
  public Integer confirmOrder (String sessionId, String body) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void confirmOrder (String sessionId, String body, final Response.Listener<Integer> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = body;
  ...
  */
  public File getFile (String fileId, String sessionId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
        Log.d("file", "localvar "+localVarResponse);
