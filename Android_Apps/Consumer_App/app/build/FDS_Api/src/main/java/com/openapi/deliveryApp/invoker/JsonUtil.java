...
public class JsonUtil {
  ...
  public static Type getListTypeForDeserialization(Class cls) {
    ...
    if ("DeliveryPersonDetails".equalsIgnoreCase(className)) {
      return new TypeToken<List<DeliveryPersonDetails>>(){}.getType();
    }
    ...
    if ("GetOrders200Response".equalsIgnoreCase(className)) {
      return new TypeToken<List<GetOrders200Response>>(){}.getType();
    }
  ...
  public static Type getTypeForDeserialization(Class cls) {
    ...
    if ("DeliveryPersonDetails".equalsIgnoreCase(className)) {
      return new TypeToken<DeliveryPersonDetails>(){}.getType();
    }
    ...
    if ("GetOrders200Response".equalsIgnoreCase(className)) {
      return new TypeToken<GetOrders200Response>(){}.getType();
    }
