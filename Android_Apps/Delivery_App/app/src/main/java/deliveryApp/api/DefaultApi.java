...
import com.openapi.deliveryApp.model.VendorAddProductImagesRequest;
...
public class DefaultApi {
  ...
  * Confirm Order Delivery
   ...
   * @return BigDecimal
  */
  public BigDecimal confirmOrder (String sessionId, String body) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
  ...
  */
  public void confirmOrder (String sessionId, String body, final Response.Listener<BigDecimal> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = body;
  ...
  * Retrieve a file, typically an image, based on the provided file ID.
   ...
   * @return String
  */
  public String getFile (String fileId, String sessionId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    ...
    // form params
    Map<String, String> formParams = new HashMap<String, String>();
    headerParams.put("fileId", ApiInvoker.parameterToString(fileId));
    headerParams.put("sessionId", ApiInvoker.parameterToString(sessionId));
    String[] contentTypes = {
    };
    String contentType = contentTypes.length > 0 ? contentTypes[0] : "application/json";
  ...
  */
  public void getFile (String fileId, String sessionId, final Response.Listener<String> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  */
  public VendorGetRequestedOrders200ResponseInner getOrders (String sessionId, String orderId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = null;
    // verify the required parameter 'sessionId' is set
    if (sessionId == null) {
    ...
    try {
      String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
      if (localVarResponse != null) {
         return (VendorGetRequestedOrders200ResponseInner) ApiInvoker.deserialize(localVarResponse, "", VendorGetRequestedOrders200ResponseInner.class);
      } else {
         return null;
      }
    } catch (ApiException ex) {
  ...
  */
  public void getOrders (String sessionId, String orderId, final Response.Listener<VendorGetRequestedOrders200ResponseInner> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((VendorGetRequestedOrders200ResponseInner) ApiInvoker.deserialize(localVarResponse,  "", VendorGetRequestedOrders200ResponseInner.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * 
   * @param sessionId 
   * @param vendorAddProductImagesRequest 
   * @return List<String>
  */
  public List<String> vendorAddProductImages (String sessionId, VendorAddProductImagesRequest vendorAddProductImagesRequest) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
    Object postBody = vendorAddProductImagesRequest;
    // verify the required parameter 'sessionId' is set
    if (sessionId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'sessionId' when calling vendorAddProductImages",
        new ApiException(400, "Missing the required parameter 'sessionId' when calling vendorAddProductImages"));
    }
    // verify the required parameter 'vendorAddProductImagesRequest' is set
    if (vendorAddProductImagesRequest == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'vendorAddProductImagesRequest' when calling vendorAddProductImages",
        new ApiException(400, "Missing the required parameter 'vendorAddProductImagesRequest' when calling vendorAddProductImages"));
    }

    // create path and map variables
    String path = "/vendor/product/addImages";
   ...
   * 
   * 
   * @param sessionId    * @param vendorAddProductImagesRequest 
  */
  public void vendorAddProductImages (String sessionId, VendorAddProductImagesRequest vendorAddProductImagesRequest, final Response.Listener<List<String>> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = vendorAddProductImagesRequest;
    ...
    // create path and map variables
    String path = "/vendor/product/addImages".replaceAll("\\{format\\}","json");
