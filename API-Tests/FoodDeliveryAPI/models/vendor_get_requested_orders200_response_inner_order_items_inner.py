...
class VendorGetRequestedOrders200ResponseInnerOrderItemsInner(BaseModel):
    """
    ...
    quantity: Union[StrictFloat, StrictInt] = Field(description="Quantity of the specific item.")
