...
class DeliveryAcceptOrderRequest(BaseModel):
    """
    DeliveryAcceptOrderRequest
    """ # noqa: E501
    order_id: Optional[Annotated[str, Field(min_length=40, strict=True, max_length=40)]] = Field(default=None, alias="orderId")
