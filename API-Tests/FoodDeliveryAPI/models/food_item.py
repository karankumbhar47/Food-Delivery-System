...
class FoodItem(BaseModel):
    ...
    rated_by: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="ratedBy")
    tags: Optional[List[StrictStr]] = Field(default=None, description="tags related to food item")
    __properties: ClassVar[List[str]] = ["itemId", "name", "thumbnail", "vendor", "price", "rating", "ratedBy", "tags"]
