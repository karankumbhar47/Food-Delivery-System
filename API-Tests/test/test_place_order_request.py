...
class TestPlaceOrderRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PlaceOrderRequest:
        """Test PlaceOrderRequest
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PlaceOrderRequest`
        """
        model = PlaceOrderRequest()
        if include_optional:
            return PlaceOrderRequest(
                item_cart = [
                    FoodDeliveryAPI.models.place_order_request_item_cart_inner.placeOrder_request_itemCart_inner(
